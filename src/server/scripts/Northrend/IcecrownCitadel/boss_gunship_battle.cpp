...
class spell_gb_burning_pitch : public SpellScriptLoader
{
    public:
        ...
        class spell_gb_burning_pitch_SpellScript : public SpellScript
        {
            ...
            void Register()
            {
                OnEffectHit += SpellEffectFn(spell_gb_burning_pitch_SpellScript::HandleDummy, EFFECT_0, SPELL_EFFECT_DUMMY);
            }
        };
    ...
    public:
        ...
        class spell_rocket_pack_AuraScript : public AuraScript
        {
            ...
            void Register()
            {
                ...
                AfterEffectRemove += AuraEffectRemoveFn(spell_rocket_pack_AuraScript::OnRemove, EFFECT_1, SPELL_AURA_DUMMY, AURA_EFFECT_HANDLE_REAL);
            }
        };
