...
break;
		...
		spellInfo->AttributesEx3 |= SPELL_ATTR3_NO_INITIAL_AGGRO;
            ...
            // Entries were not updated after spell effect change, we have to do that manually :/
                ...
                break;
			case 61614:    //Corpse Explosion (Effect, damage)
case 50444:
case 49158:
case 51325:
case 51326:
...
case 51328:
case 47496:
        spellInfo->AttributesEx4 |= SPELL_ATTR4_UNK8;
	spellInfo->AttributesEx3 |= SPELL_ATTR3_IGNORE_HIT_RESULT;
	spellInfo->AttributesEx2 |= SPELL_ATTR2_CANT_CRIT;
	spellInfo->EffectApplyAuraName[0] = SPELL_AURA_MOD_ABILITY_IGNORE_TARGET_RESIST;
    break;
            ...
            case 2378: // Minor Fortitude
                ...
                break;
			case 33719:
 			spellInfo->DurationIndex = 593;
			break;
			case 49439:
			spellInfo->DurationIndex = 28;
			break;
				 case 18754: // Импрув сука
                spellInfo->EffectApplyAuraName[0] = SPELL_AURA_ADD_FLAT_MODIFIER; // 
                spellInfo->EffectBasePoints[0] = -1.5*IN_MILLISECONDS*0.22; // на 22%
                spellInfo->EffectImplicitTargetA[0] = TARGET_UNIT_CASTER; 
                break; 
            case 18755: 
                spellInfo->EffectApplyAuraName[0] = SPELL_AURA_ADD_FLAT_MODIFIER; 
                spellInfo->EffectBasePoints[0] = -1.5*IN_MILLISECONDS*0.44; // на 44% 
                spellInfo->EffectImplicitTargetA[0] = TARGET_UNIT_CASTER; 
                break; 
            case 18756: 
                spellInfo->EffectApplyAuraName[0] = SPELL_AURA_ADD_FLAT_MODIFIER; 
                spellInfo->EffectBasePoints[0] = -1.5*IN_MILLISECONDS*0.66; // на 66%
                spellInfo->EffectImplicitTargetA[0] = TARGET_UNIT_CASTER; 
                break;
